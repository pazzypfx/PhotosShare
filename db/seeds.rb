...
users = User.create(
    [
        { username: 'admin', firstName: 'Jhon'      , lastName: 'Doe'      , email: 'email' , password_digest: User.digest('adminpass'), active: true , role: :admin },
        { username: 'user1', firstName: 'firstName1', lastName: 'lastName1', email: 'email1', password_digest: User.digest('password1'), active: true , role: :manager },
        { username: 'user2', firstName: 'firstName2', lastName: 'lastName2', email: 'email2', password_digest: User.digest('password2'), active: false, role: :agent }
    ])
